...
def single_label_parser_char_BIO(   #######用的是这个
    dir_img: str,
    dir_json_label: str,
    dir_csv_label: str,
    target_shape: Tuple[int] = None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str) #/dataset
    parser.add_argument("--mode", type=str) #"char"
    parser.add_argument("--discard_key", type=bool) #False
