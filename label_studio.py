...
def do_convert():
    ...
    if args.task_type == "ext":
        train_examples = data_converter.convert_ext_examples(raw_examples[:p1], save_dir=args.save_dir)
        dev_examples = data_converter.convert_ext_examples(raw_examples[p1:p2], save_dir=args.save_dir, is_train=False)
        test_examples = data_converter.convert_ext_examples(raw_examples[p2:], save_dir=args.save_dir, is_train=False)
    else:
        train_examples = data_converter.convert_cls_examples(raw_examples[:p1], save_dir=args.save_dir)
        dev_examples = data_converter.convert_cls_examples(raw_examples[p1:p2], save_dir=args.save_dir)
        test_examples = data_converter.convert_cls_examples(raw_examples[p2:], save_dir=args.save_dir)
